...
class _ResetPasswordFormState extends ConsumerState<ResetPasswordForm> {
  ...
  Future<void> _resetPassword() async {
    final _authProvider = ref.read(authController.notifier);
    ...
    if (_isValid) {
      ...
      bool _isOTPValid = await _authProvider.validateOTP(
          otp: int.parse(_otp.text), email: email);
      if (_isOTPValid) {
        bool _passwordReseted = await _authProvider.resetPassword(
